...
RSpec.describe 'VM Backups: Rsync - Incremental backups' do
    before(:all) do
    ...
    BackupTests.incremental_vms.each do |i|
        it_should_behave_like 'incremental backups', i, RSyncDS, 'CBT'

        it_should_behave_like 'incremental backups', i, RSyncDS, 'SNAPSHOT'
    end
end
