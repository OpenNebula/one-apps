    ...
    context 'VNF VM Scenario 4: (VNF + vm1, vm2) - LB enabled with LB[0-9] and static servers' do
        include_examples 'deploy_vnf', name, hv, 'vd',
                         ...
                         [{ :name => 'vm1', :net => :vnet_a, :context => VM_CONTEXT_NGINX_WEB_SERVER },
                          { :name => 'vm2', :net => :vnet_b,
:context => VM_CONTEXT_NGINX_WEB_SERVER }]
    ...
    context 'VNF VROUTER Scenario 3: (VROUTER + vm1, vm2 + vm3) - SNAT/DNAT from vnet_dmz to vnet_a (no interfaces)' do
        include_examples 'deploy_vrouter', name, hv, 'vd',
                         ...
                         [{ :name => 'vm1', :net => :vnet_a, :context => VM_CONTEXT_SIMPLE_WEB_SERVER },
                          { :name => 'vm2', :net => :vnet_b,
:context => VM_CONTEXT_SIMPLE_WEB_SERVER },
...
:context => VM_CONTEXT_SIMPLE_WEB_SERVER }]
        ...
        include_examples 'vnf_haproxy_setup_dynamic_backend_server', 'vr1', 'vm1', 0, 'tcp',
                         '8080', '8080'
        include_examples 'vnf_haproxy_setup_dynamic_backend_server', 'vr1', 'vm1', 1, 'tcp',
                         '3002', '8080'
        include_examples 'vnf_haproxy_setup_dynamic_backend_server', 'vr1', 'vm2', 0, 'tcp',
                         '8080', '8080'
        include_examples 'vnf_haproxy_setup_dynamic_backend_server', 'vr1', 'vm2', 1, 'tcp',
                         '3002', '8080'
