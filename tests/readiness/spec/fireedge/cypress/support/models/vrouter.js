...
class VRouter extends OpenNebulaResource {
  /**
  ...
  info() {
    ...
    return cy.apiGetVRouter(id).then((vrouterInstance) => {
      this.json = vrouterInstance

      return vrouterInstance
    })
  }

  /**
   * Instantiates a new VRouterTemplate in OpenNebula.
   *
  ...
  instantiate(body) {
    return cy
      .apiInstantiateVRouterTemplate(body)
      .then((response) => {
