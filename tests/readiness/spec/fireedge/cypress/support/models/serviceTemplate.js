...
class ServiceTemplate extends OpenNebulaResource {
  /**
  ...
  info() {
    ...
    return cy.apiGetServiceTemplate(id).then((servicetemplate) => {
      this.json = servicetemplate
  ...
  /**
   * Allocates a new servicetemplate in OpenNebula.
   *
  ...
  allocate(body) {
    return cy
      .apiAllocateServiceTemplate(body)
      .then((response) => {
