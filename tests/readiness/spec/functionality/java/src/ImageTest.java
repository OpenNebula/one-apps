...
public class ImageTest
{
    ...
    private static String template_persis()
    {
        cont++;

        return  "NAME = \"test_img_persis" + cont + "\"\n" +
                "SIZE = 1\n" +
                "ATT1 = \"VAL1\"\n" +
                "TYPE = DATABLOCK\n"+
                "PERSISTENT = \"YES\"\n"+
    ...
    public void allocate()
    {
        ...
        res = Image.allocate(client, template_persis(), 1);
        ...
        imgid = res.isError() ? -1 : Integer.parseInt(res.getMessage());
        image = new Image(imgid, client);
        ...
        {
            found = found || img.getName().equals("test_img_"+cont) || ( img.getName().equals("test_img_persis_"+(cont-1)) && img.xpath("PERSISTENT").equals( 1 ));
        }
