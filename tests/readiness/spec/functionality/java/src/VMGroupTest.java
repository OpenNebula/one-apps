...
public class VMGroupTest
{
    ...
    public void info()
    {
        ...
        assertTrue( vmg.xpath("ROLES/ROLE/NAME").equals("web") );
    }
    ...
    public void rename()
    {
        ...
        assertTrue( vmg.getName().equals("renamed") );
    }
    ...
    public void lock()
    {
        ...
        res = vmg.info();
        assertTrue( res.getErrorMessage(), !res.isError() );
        assertTrue( vmg.xpath("LOCK/LOCKED").equals("1") );
        ...
        res = vmg.info();
        assertTrue( res.getErrorMessage(), !res.isError() );
        assertTrue( vmg.xpath("LOCK").isEmpty() );
    }

    @Test
    public void roleAdd()
    {
        res = vmg.roleAdd("ROLE = [ NAME = \"db\" ]");
        assertTrue( res.getErrorMessage(), !res.isError() );

        res = vmg.info();
        assertTrue( res.getErrorMessage(), !res.isError() );

        assertTrue( vmg.xpath("ROLES/ROLE[ID=0]/NAME").equals("web") );
        assertTrue( vmg.xpath("ROLES/ROLE[ID=1]/NAME").equals("db") );
    }

    @Test
    public void roleDelete()
    {
        res = vmg.roleDelete(0);
        assertTrue( res.getErrorMessage(), !res.isError() );

        res = vmg.info();
        assertTrue( res.getErrorMessage(), !res.isError() );

        assertTrue( vmg.xpath("ROLES/ROLE").isEmpty() );
    }

    @Test
    public void roleUpdate()
    {
        res = vmg.roleUpdate(0, "ROLE = [ POLICY = \"AFFINED\" ]");
        assertTrue( res.getErrorMessage(), !res.isError() );
        ...
        assertTrue( vmg.xpath("ROLES/ROLE[ID=0]/NAME").equals("web") );
        assertTrue( vmg.xpath("ROLES/ROLE[ID=0]/POLICY").equals("AFFINED") );
    }
}
