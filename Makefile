...
packer-service_SlurmController: packer-ubuntu2604 $(DIR_EXPORT)/service_SlurmController.qcow2
...
packer-service_SlurmController.aarch64: packer-ubuntu2604.aarch64 $(DIR_EXPORT)/service_SlurmController.aarch64.qcow2
	@$(INFO) "Packer service_SlurmController.aarch64 done"

packer-service_SlurmWorker: packer-ubuntu2604 $(DIR_EXPORT)/service_SlurmWorker.qcow2
