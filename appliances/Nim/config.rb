...
NVIDIA_REGISTRY      = env(:ONEAPP_NIM_NVIDIA_REGISTRY, '')
NVIDIA_REGISTRY_USER = env(:ONEAPP_NIM_NVIDIA_REGISTRY_USER, '')
NVIDIA_REGISTRY_KEY  = env(:ONEAPP_NIM_NVIDIA_REGISTRY_KEY, '')
NVIDIA_IMAGE_REF     = env(:ONEAPP_NIM_NVIDIA_IMAGE_REF, '')
