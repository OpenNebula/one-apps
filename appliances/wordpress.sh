...
DEP_PKGS="coreutils httpd mod_ssl mariadb mariadb-server php php-common php-mysqlnd php-gd php-xml php-mbstring php-mcrypt unzip wget curl openssl expect ca-certificates"
