...
CAPI_GITEA_VERSION        = env :ONEAPP_CAPI_GITEA_VERSION, '11.0.1'
...
CAPI_GITEA_DOMAIN   = env :ONEAPP_CAPI_GITEA_DOMAIN, nil
CAPI_GITEA_ROOT_URL = env :ONEAPP_CAPI_GITEA_ROOT_URL, "https://#{CAPI_GITEA_DOMAIN || ETH0_IP}/gitea/"
CAPI_GITEA_PASSWORD = env :ONEAPP_CAPI_GITEA_PASSWORD, 'capi1234'
