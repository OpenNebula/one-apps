...
ONEAPP_DYNAMO_RELEASE_VERSION = env :ONEAPP_DYNAMO_RELEASE_VERSION, '0.0.1'
ONEAPP_DYNAMO_ENGINE_NAME = env :ONEAPP_DYNAMO_ENGINE_NAME, 'vllm' # available: mistralrs|sglang|llamacpp|vllm|trtllm|echo_full|echo_core
